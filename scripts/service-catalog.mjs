...
export const treatmentsByCategory = {
  ...
  "dermal-fillers-skin-boosters": [
    ...
    },
    {
      ...
      afterImage: "/images/treatments/lip-filler.jpg",
      popular: true,
      order: 2,
      bookingUrl: FRESHA_MAIN,
      sections: buildSections({
  ...
  "microneedling-skin-resurfacing": [
    ...
    {
      name: "IPL & BBL Photofacial",
      slug: "ipl-photofacial",
      shortDescription:
        "Advanced light-based skin rejuvenation treatments designed to improve sun damage, redness, pigmentation, and uneven skin tone.",
      price: "From $149",
      ...
      sections: buildSections({
        ...
        about: {
          content:
            "IPL (Intense Pulsed Light) and BBL (BroadBand Light) Photofacials use controlled pulses of light energy to target pigmentation, sun damage, redness, and visible blood vessels within the skin. The light energy is absorbed by areas of excess pigment and vascular concerns, helping to reduce their appearance and promote a clearer, more even complexion.\n\nThis non-invasive treatment can address concerns such as sun spots, freckles, redness, rosacea-related flushing, broken capillaries, and uneven skin tone. Results develop gradually over the following weeks as treated areas naturally improve, revealing smoother and more balanced-looking skin.",
        },
        benefits: {
          items: [
        ...
        idealFor:
          "Clients looking to improve sun damage, pigmentation, redness, visible capillaries, or uneven skin tone. Ideal for those seeking a non-invasive treatment to restore a clearer, more balanced complexion.",
        recovery:
  ...
  "laser-hair-removal": [
    ...
    {
      name: "Medium Area Laser Hair Removal (Underarms, Arms, Half Legs, Abdomen, or Bikini)",
      slug: "medium-area",
      shortDescription:
  ...
  "body-sculpting-contouring": [
    {
      ...
      sections: buildSections({
        ...
        about: {
          content:
            "HIFEM (High-Intensity Focused Electromagnetic) technology is a non-invasive muscle toning treatment that uses electromagnetic energy to stimulate intense muscle contractions in targeted areas. These contractions help support muscle strengthening, definition, and improved muscle tone.\n\nThis treatment can be customized for areas such as the abdomen, glutes, and arms to complement your fitness routine and enhance your body contouring goals. No surgery, needles, or downtime are required.",
        },
        benefits: {
          items: [
            "Helps tone and strengthen targeted muscles",
            "Supports improved muscle definition",
            "Targets areas such as the abdomen, glutes, and arms",
        ...
        idealFor:
          "Clients looking to enhance muscle tone and definition in targeted areas such as the abdomen, glutes, or arms. Ideal for those seeking a non-invasive option to complement their fitness goals and body contouring journey.",
        recovery:
          "No downtime required. Some clients may experience temporary muscle fatigue or soreness similar to the feeling after exercise, which typically resolves within a short period. Normal activities can be resumed immediately after treatment.",
      }),
    },
  ],
};
