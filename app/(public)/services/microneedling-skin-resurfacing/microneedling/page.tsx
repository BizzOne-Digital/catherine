...
const relatedTreatments = [
  { name: "IPL Photofacial", slug: "ipl-photofacial", price: "From $250", image: "/images/treatments/ipl-photofacial.jpg" },
];
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-text-soft leading-relaxed font-medium mb-8">
                Collagen-stimulating treatment for texture, pores and scars.
              </p>
          ...
          <div className="max-w-4xl mx-auto">
            <ScrollReveal>
              ...
              <p className="text-lg text-text-soft leading-relaxed mb-6 font-medium">
                Microneedling uses fine needles to create controlled micro-injuries in the skin, triggering your body's natural healing response and boosting collagen and elastin production. This results in smoother, firmer, and more even-toned skin.
              </p>
              <p className="text-lg text-text-soft leading-relaxed font-medium">
                Ideal for improving skin texture, reducing the appearance of acne scars, minimizing pore size, and addressing fine lines. Results appear gradually over several weeks as new collagen forms.
              </p>
            </ScrollReveal>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
            <ScrollReveal>
              <div className="p-8 bg-gradient-to-br from-gold/5 to-gold/10 rounded-2xl border border-gold/20">
                ...
                <p className="text-text-dark font-medium leading-relaxed">
                  Acne scarring, enlarged pores, uneven texture, fine lines, or anyone seeking to improve overall skin quality and firmness.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.1}>
              <div className="p-8 bg-gradient-to-br from-gold/5 to-gold/10 rounded-2xl border border-gold/20">
                ...
                <p className="text-text-dark font-medium leading-relaxed">
                  Mild redness for 24-48 hours. Skin may feel tight or sensitive for a few days. Avoid sun exposure and follow post-care instructions.
                </p>
              </div>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-text-soft mb-8 font-medium">
                Book your complimentary consultation and discover if Microneedling is right for you.
              </p>
