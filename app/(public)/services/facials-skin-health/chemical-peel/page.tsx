          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-text-soft leading-relaxed font-medium mb-8">
                Resurface for brighter, clearer, more even-toned skin.
              </p>
              <div className="flex items-center justify-center gap-2 mb-8">
                <DollarSign size={20} className="text-gold" />
                <div>
                  <p className="text-xs text-text-soft uppercase tracking-wide">Price</p>
                  <p className="text-lg font-bold text-gold">From $150</p>
                </div>
              </div>
              <Link
                href="/booking"
          ...
          <div className="max-w-4xl mx-auto">
            <ScrollReveal>
              ...
              <p className="text-lg text-text-soft leading-relaxed mb-6 font-medium">
                Chemical peels use medical-grade acids to exfoliate the top layers of skin, revealing fresher, brighter skin underneath. This treatment addresses pigmentation, acne scarring, fine lines, and uneven texture.
              </p>
              <p className="text-lg text-text-soft leading-relaxed font-medium">
                We offer customized peel strengths based on your skin type and concerns. Results improve with a series of treatments for optimal skin transformation.
              </p>
            </ScrollReveal>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
            <ScrollReveal>
              <div className="p-8 bg-gradient-to-br from-gold/5 to-gold/10 rounded-2xl border border-gold/20">
                ...
                <p className="text-text-dark font-medium leading-relaxed">
                  Pigmentation, acne scarring, sun damage, fine lines, or uneven texture. Best results with a treatment series.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.1}>
              <div className="p-8 bg-gradient-to-br from-gold/5 to-gold/10 rounded-2xl border border-gold/20">
                ...
                <p className="text-text-dark font-medium leading-relaxed">
                  3-7 days of flaking depending on peel strength. Avoid sun exposure and follow post-care instructions carefully.
                </p>
              </div>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-text-soft mb-8 font-medium">
                Book your complimentary consultation and discover if chemical peels are right for you.
              </p>
